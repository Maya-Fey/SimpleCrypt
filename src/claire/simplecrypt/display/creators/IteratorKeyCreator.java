...
public class IteratorKeyCreator 
	   extends KeyCreatorPanel<IteratorKey> {
	...
	{
		JLabel l1 = new JLabel("Enter Initial Position: ");
	...
	{
		return new IteratorKey(this.getAlphabet(), Base10.stringToInt(field.getText()));
	}
